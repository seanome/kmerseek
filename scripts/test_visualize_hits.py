...
def _row(target_name="tgt", region_start=0, region_end=10, region_length=10,
         ...
         region_poisson_pvalue=0.01, region_enrichment=2.0, region_minority_fraction=0.4,
    ...
    return {
        ...
        "moltype": moltype,
        "jaccard": str(jaccard),
        "max_containment": str(containment),
        "average_abund": "1.0",
        "median_abund": "1.0",
        "std_abund": "0.0",
        "containment_target_in_query": str(containment),
        "f_weighted_target_in_query": "1.0",
        "query_tfidf": "1.0",
        "mean_matched_kmer_freq": "0.1",
        "sum_matched_kmer_freq": "0.5",
        "query_expected_shared_kmers": "1.0",
        "query_enrichment": str(query_enrichment),
        "joint_kmer_freq": "0.0",
        "query_poisson_pvalue": str(query_poisson_pvalue),
        ...
        "target_start": str(region_start),
        "target_end": str(region_end),
        ...
        "region_poisson_pvalue": str(region_poisson_pvalue),
        "region_enrichment": str(region_enrichment),
        "region_minority_fraction": str(region_minority_fraction),
    }
